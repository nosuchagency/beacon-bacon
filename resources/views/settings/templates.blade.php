      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="form-group">
            {!! Form::label('mail-templates-reset-subject', __('Subject'), ['class' => 'control-label']) !!}
            {!! Form::text('mail-templates-reset-subject', config('mail.templates.reset.subject'), ['class' => 'form-control', 'placeholder' => __('Your Password Reset Link')]) !!}
          </div>
          <div class="form-group">
            ...
            <p>
              {{__('Use the placeholder')}} <code>@{{ link }}</code> {{__('to insert the reset link.')}}
            </p>
          </div>
        </div>
