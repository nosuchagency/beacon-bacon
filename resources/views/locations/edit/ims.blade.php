  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="width: 650px;">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Please IMS on Map</h4>
      </div>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              {!! Form::text('parameter_one', $location->parameter_one, ['class' => 'form-control', 'placeholder' => 'Enter IMS Identifier']) !!}
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
				<button type="button" class="btn btn-info pull-right" data-toggle="modal" data-target="#mapModal">Place IMS on Map</button>
            </div>
          </div>
